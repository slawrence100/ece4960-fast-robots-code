...
#define PITCH_CONSTANT 0.9993
#define ROLL_CONSTANT 0.9995
...
void printScaledAGMT(ICM_20948_I2C *sensor){
  ...
  if (first) {
    ...
    pitch = PITCH_CONSTANT * accPitch + (1 - PITCH_CONSTANT) * pitch;
    roll = ROLL_CONSTANT * accRoll + (1 - ROLL_CONSTANT) * roll;
  }
